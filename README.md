...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Algorithm-Recursion-2b6cb0?style=flat-square" alt="Recursion">
...
- Main File: `python task2.py`
- Main File + Test File: `python -m unittest test_task2.py -v`

## Test Results

- `python -m unittest test_task2.py -v` - Passed as shown below

![Test results screenshot](results.png)
